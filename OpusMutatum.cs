...
namespace OpusMutatum {
	...
	public class OpusMutatum {
		...
		static string StringDeobfName = "#=qZ$OCswqJ6WLLnQIn63CqHEPImVW2WzpedQI9Lc543C8=.#=q2KlmxwmmupVOJfkzw8hNTw==";
		static string StringDeobfIntermediaryName = "method_1718";
